...
%Use line below and replace current for statement for all 192 plots
...
for i = 1:6
    ...
    if solver_current == "ode1"
        ...
        %Use line below and replace current while statement if looking to solve for all plots
        %while x < 190
        while x < 4
...
%Variable Time Step
%Use line below and replace current for statement for all 64 plots for every combination 
